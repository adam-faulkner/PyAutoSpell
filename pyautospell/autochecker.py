...
from pyautospell.nlp_utils_factory import NLPUtilsFactory
from pyautospell.suggestion_scorer import SuggestionScorer
from pyautospell.hunspell_checker import HunspellChecker
from pyautospell.suggestion_scorer_lm import SuggestionScorerLM
from pyautospell.IFL_suggestion_selector import IFLSuggestionSelector
from pyautospell.spell_corrector_ranked import SpellCorrectorRanked
...
class AutoChecker(SpellChecker):
    ...
    def score_suggestion(self, suggestion, line):
        '''
        :param suggestion:
        :param line:
        :return:
    ...
    def check_spelling(self, text, suggestions_count):
        '''
        :param text:
        :param suggestions_count:
        :return:
